  ...
  return (
    <section id="contact" className="section-padding relative overflow-hidden">
      ...
      <div className="container relative z-10">
        ...
        >
          <div className="gradient-border rounded-2xl p-6 md:p-10 bg-card text-center">
            ...
            <div className="grid md:grid-cols-2 gap-4 pt-4">
              <div className="flex items-start justify-center gap-2 text-muted-foreground text-xs">
